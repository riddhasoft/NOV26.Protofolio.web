...
namespace NOV26.Protofolio.web.Controllers
{
    public class SkillModelsController : Controller
    {
        ...
        public SkillModelsController(NOV26ProtofoliowebContext context)
        {
            _context = context;
        }
        ...
        {
              return _context.SkillModel != null ? 
                          View(await _context.SkillModel.ToListAsync()) :
                          Problem("Entity set 'NOV26ProtofoliowebContext.SkillModel'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'NOV26ProtofoliowebContext.SkillModel'  is null.");
            }
            var skillModel = await _context.SkillModel.FindAsync(id);
            if (skillModel != null)
            {
