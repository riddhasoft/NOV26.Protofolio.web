...
namespace NOV26.Protofolio.web.Controllers
{
    ...
    public class UserModelsController : Controller
    {
        ...
        public UserModelsController(NOV26ProtofoliowebContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.UserModel != null ? 
                          ...
                          Problem("Entity set 'NOV26ProtofoliowebContext.UserModel'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'NOV26ProtofoliowebContext.UserModel'  is null.");
            }
            var userModel = await _context.UserModel.FindAsync(id);
            if (userModel != null)
            {
