...
namespace NOV26.Protofolio.web.Controllers
{
    public class PersonalInformationModelsController : Controller
    {
        ...
        public PersonalInformationModelsController(NOV26ProtofoliowebContext context)
        {
            _context = context;
        }
        ...
        {
            return _context.PersonalInformationModel != null ?
                        View(await _context.PersonalInformationModel.ToListAsync()) :
                        Problem("Entity set 'NOV26ProtofoliowebContext.PersonalInformationModel'  is null.");
        }

        // GET: PersonalInformationModels/Details/5
        public async Task<IActionResult> Details(int? id)
        {
            if (id == null || _context.PersonalInformationModel == null)
            {
                return NotFound();
            }
        ...
        public async Task<IActionResult> Create([Bind("Id,FullName,Title,Summary,Address,DOB,Email,ZipCode,Phone,CompletedProjects,UserPhotoUrl")] PersonalInformationModel personalInformationModel, IFormFile UserPhotoUrl)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,FullName,Title,Summary,Address,DOB,Email,ZipCode,Phone,CompletedProjects,UserPhotoUrl")] PersonalInformationModel personalInformationModel)
        {
        ...
        {
            if (_context.PersonalInformationModel == null)
            {
                return Problem("Entity set 'NOV26ProtofoliowebContext.PersonalInformationModel'  is null.");
            }
            var personalInformationModel = await _context.PersonalInformationModel.FindAsync(id);
            if (personalInformationModel != null)
            {
        ...
        {
            return (_context.PersonalInformationModel?.Any(e => e.Id == id)).GetValueOrDefault();
        }
    }
}
