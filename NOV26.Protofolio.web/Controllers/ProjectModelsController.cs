...
namespace NOV26.Protofolio.web.Controllers
{
    public class ProjectModelsController : Controller
    {
        ...
        public ProjectModelsController(NOV26ProtofoliowebContext context)
        {
            _context = context;
        }
        ...
        {
            var nOV26ProtofoliowebContext = _context.ProjectModel.Include(p => p.Service);
            return View(await nOV26ProtofoliowebContext.ToListAsync());
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'NOV26ProtofoliowebContext.ProjectModel'  is null.");
            }
            var projectModel = await _context.ProjectModel.FindAsync(id);
            if (projectModel != null)
            {
