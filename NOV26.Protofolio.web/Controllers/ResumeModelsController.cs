...
namespace NOV26.Protofolio.web.Controllers
{
    public class ResumeModelsController : Controller
    {
        ...
        public ResumeModelsController(NOV26ProtofoliowebContext context)
        {
            _context = context;
        }
        ...
        {
              return _context.ResumeModel != null ? 
                          View(await _context.ResumeModel.ToListAsync()) :
                          Problem("Entity set 'NOV26ProtofoliowebContext.ResumeModel'  is null.");
        }

        // GET: ResumeModels/Details/5
        public async Task<IActionResult> Details(int? id)
        {
            if (id == null || _context.ResumeModel == null)
            {
                return NotFound();
            }
        ...
        {
            if (_context.ResumeModel == null)
            {
                return Problem("Entity set 'NOV26ProtofoliowebContext.ResumeModel'  is null.");
            }
            var resumeModel = await _context.ResumeModel.FindAsync(id);
            if (resumeModel != null)
            {
        ...
        {
          return (_context.ResumeModel?.Any(e => e.Id == id)).GetValueOrDefault();
        }
    }
}
